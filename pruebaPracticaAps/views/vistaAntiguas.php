...
<html>
<head>
    <title>Actualizaciones Antiguas</title>
     <meta charset="UTF-8">
    ...
    <div class="sidebar">
        ...
        <a href="../controllers/controlActualizacion.php"><i class="fas fa-sliders-h"></i><span>Historial</span></a>    
            ...
            <div align="center">
                ...
                <h2 class="titulo" align="center">Antiguas Actualizados</h2>
            </div>
...
<div id="color">
    ...
    <div class="right_area">
        <a href="../controllers/controlActualizacion.php"><i class="fas fa-desktop"></i><span><---Ver Actualizaciones Recientes</span></a>
